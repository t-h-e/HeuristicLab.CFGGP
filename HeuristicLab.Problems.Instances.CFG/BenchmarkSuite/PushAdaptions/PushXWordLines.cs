...
namespace HeuristicLab.Problems.Instances.CFG {
  public class PushXWordLines : XWordLines {
    protected override IEnumerable<DataType> InputDataTypes { get { return new List<DataType>() { DataType.String, DataType.Integer }; } }
