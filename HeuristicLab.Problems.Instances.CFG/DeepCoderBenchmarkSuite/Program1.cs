...
namespace HeuristicLab.Problems.Instances.CFG {
  public class Program1 : DeepCoderDataDescritpor<Tuple<List<int>, List<int>>> {
    public override string Name { get { return "Program1"; } }
    public override string Description { get { return ""; } }

    public override string Identifier { get { return "Program1"; } }
    ...
    protected override Tuple<string[], string[]> GenerateInputOutput(IEnumerable<Tuple<List<int>, List<int>>> trainingAndTest) {
      ...
      var output = trainingAndTest.Select(x => x.Item1.Select(y => y * 3).Zip(x.Item2, (a, b) => a + b).Max().ToString()).ToArray();
