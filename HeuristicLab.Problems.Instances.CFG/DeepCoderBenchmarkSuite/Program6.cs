...
namespace HeuristicLab.Problems.Instances.CFG {
  public class Program6 : DeepCoderDataDescritpor<Tuple<List<int>, List<int>>> {
    public override string Name { get { return "Program6"; } }
    public override string Description { get { return ""; } }

    public override string Identifier { get { return "Program6"; } }
    ...
    protected override Tuple<string[], string[]> GenerateInputOutput(IEnumerable<Tuple<List<int>, List<int>>> trainingAndTest) {
      ...
      var output = trainingAndTest.Select(x => x.Item1.Select(y => y - 1).Zip(x.Item2.Select(y => y - 1), (a, b) => a + b).Min().ToString()).ToArray();
