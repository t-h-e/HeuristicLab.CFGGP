...
namespace HeuristicLab.Problems.Instances.CFG {
  public class Program5 : DeepCoderDataDescritpor<List<int>> {
    public override string Name { get { return "Program5"; } }
    public override string Description { get { return ""; } }

    public override string Identifier { get { return "Program5"; } }
    ...
    protected override Tuple<string[], string[]> GenerateInputOutput(IEnumerable<List<int>> trainingAndTest) {
      ...
      var output = trainingAndTest.Select(x => {
        var y = x.ToList();
        y.Reverse();
        var z = x.Zip(y, (a, b) => Math.Min(a, b));
