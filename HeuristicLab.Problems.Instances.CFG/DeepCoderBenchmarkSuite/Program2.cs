...
namespace HeuristicLab.Problems.Instances.CFG {
  public class Program2 : DeepCoderDataDescritpor<Tuple<List<int>, List<int>>> {
    public override string Name { get { return "Program2"; } }
    public override string Description { get { return ""; } }

    public override string Identifier { get { return "Program2"; } }
    ...
    protected override Tuple<string[], string[]> GenerateInputOutput(IEnumerable<Tuple<List<int>, List<int>>> trainingAndTest) {
      ...
      var output = trainingAndTest.Select(x => x.Item2.Zip(x.Item1, (a, b) => a - b).Count(y => y > 0).ToString()).ToArray();
