...
namespace HeuristicLab.Problems.CFG.Python.Views {
  [Plugin("HeuristicLab.Problems.CFG.Python.Views", "Provides views for grammar based problems in python", "3.3.13.0")]
  [PluginFile("HeuristicLab.Problems.CFG.Python.Views.dll", PluginFileType.Assembly)]
