...
namespace HeuristicLab.Problems.CFG.Python.Semantics.Manipulators {
  [StorableClass]
  [Item("Semantic2TestCrossover", "AnyChange.")]
  public class Semantic2TestCrossover<T> : SemanticTestAnalyzationManipulator<T>
     where T : class, ICFGPythonProblemData {

    [StorableConstructor]
    protected Semantic2TestCrossover(bool deserializing) : base(deserializing) { }
    protected Semantic2TestCrossover(Semantic2TestCrossover<T> original, Cloner cloner) : base(original, cloner) {
    }
    public Semantic2TestCrossover() { }

    public override IDeepCloneable Clone(Cloner cloner) {
      return new Semantic2TestCrossover<T>(this, cloner);
    }
