...
namespace HeuristicLab.Problems.CFG.Python.Semantics {
  ...
  public class Semantic5TestManipulator<T> : SemanticTestAnalyzationManipulator<T>
    ...
    [StorableConstructor]
    protected Semantic5TestManipulator(bool deserializing) : base(deserializing) { }
    protected Semantic5TestManipulator(Semantic5TestManipulator<T> original, Cloner cloner) : base(original, cloner) {
    }
    public Semantic5TestManipulator() { }

    public override IDeepCloneable Clone(Cloner cloner) {
      return new Semantic5TestManipulator<T>(this, cloner);
    }
