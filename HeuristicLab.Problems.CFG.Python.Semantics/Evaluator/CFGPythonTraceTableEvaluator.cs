...
namespace HeuristicLab.Problems.CFG.Python.Semantics {
  ...
  where T : class, ICFGPythonProblemData {
    ...
    public override IOperation InstrumentedApply() {
      var result = pythonSemanticHelper.EvaluateAndTraceProgram(PythonProcessParameter.ActualValue, Program, Input, Output, ProblemData.TrainingIndices, ProblemData.FullHeader, ProblemData.FullFooter, SymbolicExpressionTreeParameter.ActualValue, Timeout);
