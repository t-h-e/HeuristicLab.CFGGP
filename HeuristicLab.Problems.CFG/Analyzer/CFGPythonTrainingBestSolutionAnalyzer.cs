...
namespace HeuristicLab.Problems.CFG {
  ...
  public class CFGPythonTrainingBestSolutionAnalyzer : SingleSuccessorOperator, IIterationBasedOperator, ICFGPythonAnalyzer {
    ...
    public ILookupParameter<CFGPythonSolution> TrainingBestSolutionParameter {
      get { return (ILookupParameter<CFGPythonSolution>)Parameters[TrainingBestSolutionParameterName]; }
    }
    ...
    public CFGPythonSolution TrainingBestSolution {
    ...
    public CFGPythonTrainingBestSolutionAnalyzer()
      ...
      Parameters.Add(new LookupParameter<CFGPythonSolution>(TrainingBestSolutionParameterName, "The training best cfg solution."));
    ...
    public override IOperation Apply() {
      ...
      if (bestTree != null && (UpdateAlways.Value || TrainingBestSolutionQuality == null ||
        ...
        TrainingBestSolution = new CFGPythonSolution(bestTree, ProblemDataParameter.ActualValue, TimeoutParameter.ActualValue, HeaderParameter.ActualValue, FooterParameter.ActualValue);
